...
The Dispatch CLI (`dispatch`) lets you publish OTA updates for your Expo & React Native app from the command line.
...
| [`dispatch init`](/cli/init) | Initialize a project for OTA updates |
| [`dispatch publish`](/cli/publish) | Export and publish an OTA update |
